    ...
    <div className='relative min-h-screen'>
      ...
      >
        <div
          ...
          className='sticky top-0 z-20 flex min-h-[64px] w-full items-center justify-between border-b border-slate-300 bg-white'
        >
          <TopLeft>
        ...
        {/* page content */}
        <div data-name='content' className='relative min-h-screen pr-80'>
          {/* page load here */}
          <PageContent />
          <PageBottom />
          <PageRight>
            <div className='p-4 font-mono text-sm uppercase opacity-50'>
